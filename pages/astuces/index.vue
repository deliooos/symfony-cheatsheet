...
const options = computed<UseFuseOptions<AstuceItem>>(() => ({
  fuseOptions: {
...
<template>
  <main class="classic-main">
    <h1 class="text-5xl font-bold mb-3">Découvrez toutes les astuces</h1>
    <form class="mb-10">
      <label class="label">
        <span class="label-text">Recherche</span>
      </label>
      <div class="input-group">
        <input v-model="search" type="text" placeholder="Rechercher une astuce…" class="input input-bordered" />
